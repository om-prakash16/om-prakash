...
const EXPERIENCES = [
  {
    ...
    company: 'SuntecIndia',
    tags: ['Bill.com', 'RetailBackbone', 'Invoice Processing', 'Excel', 'SaaS Operations'],
    desc: 'Working as a Process Associate at SuntecIndia. Managing billing operations using Bill.com and RetailBackbone.com — creating and processing invoices, and using Excel for fast data matching and reconciliation.',
    color: '#00e5ff',
    status: 'active',
  },
  {
    ...
    tags: ['Technical Writing', 'Python', 'Data Structures', 'Algorithms', 'Web Development'],
    desc: 'Authored in-depth articles on Python, Data Structures, Algorithms, HTML/CSS, and web development — simplifying complex engineering concepts into practical, beginner-friendly guides.',
    color: '#8b5cf6',
    status: 'past',
  },
]
